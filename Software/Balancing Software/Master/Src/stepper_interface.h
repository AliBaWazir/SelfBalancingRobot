...
EXTERNC void setStepperSpeedL(float speed);
EXTERNC void setStepperSpeedR(float speed);
...
EXTERNC int32_t stepperCurrentPositionR(void);
EXTERNC int32_t stepperCurrentPositionL(void);
EXTERNC void stepperMove(int32_t);
EXTERNC void setStepperCurrentPosition(int32_t);
EXTERNC void setStepperCurrentPositionR(int32_t);
EXTERNC void setStepperCurrentPositionL(int32_t);
